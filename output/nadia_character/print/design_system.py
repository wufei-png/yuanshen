...
POSTCARDS = [
    ...
    },
    {
        ...
        "subtitle": "-2 · -1 · 0 · +1 · +2",
        "back_title": "从归衡开始",
        "back_body": "元素战技启动时，H 从 0 开始。左侧是轻端，右侧是重端；到达端点后进入对应观测状态。",
        "tag": "机制总览",
    ...
    },
    {
        ...
        "subtitle": "浮动、牵引、多目标。",
        "back_title": "普莎响应",
        "back_body": "有效触发 Stellar Swirl 时，H 向轻端移动一格。普莎缓缓离地，雪粒反常地向上飘动。",
        "tag": "轻端响应",
    ...
    },
    {
        ...
        "subtitle": "压制、迟滞、单目标。",
        "back_title": "伊嘉响应",
        "back_body": "有效触发 Stellar-Conduct 时，H 向重端移动一格。伊嘉落地，造成低沉的冰裂与稳定压制。",
        "tag": "重端响应",
    ...
    },
    {
        ...
        "subtitle": "轻与重不互相抵消。",
        "back_title": "归衡响应",
        "back_body": "当 H 从任一端回到 0，两只猫的轨迹交汇，短暂共同稳定战场，并打开一次 Stellar 反应强化窗口。",
        "tag": "归衡",
        "image": "nadia_h_zero_v1_ingame.png",
        "mode": "right_contain",
    },
    {
        ...
        "back_title": "稳定的基础协同",
        "back_body": "技能本身就提供基础冰元素协同；Stellar 反应只负责选择轻端或重端路线，不是让技能开始工作的前提。",
        "tag": "战技",
    ...
    },
    {
        ...
        "subtitle": "轻中有重，重中有轻。",
        "back_title": "雪原校准",
        "back_body": "建立零点测区，让 H 回到中央。持续期间，触发一种路线时，另一只猫也会提供较弱的伴随响应。",
        "tag": "爆发",
        "image": "nadia_splash_v4_canonical_refined.png",
        "mode": "contain",
    },
    {
        ...
        "back_title": "把失衡带回来",
        "back_body": "连续同类反应会稳定对应观测状态；从端点返回 0 时，归衡响应得到强化。具体倍率留待战斗测试。",
        "tag": "天赋",
        "image": "nadia_h_zero_v1_ingame.png",
        "mode": "right_contain",
    },
