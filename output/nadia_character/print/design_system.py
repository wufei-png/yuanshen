...
POSTCARDS = [
    ...
    },
    {
        ...
        "subtitle": "至冬 · 冰 · 法器 · 五星",
        "back_title": "双衡仪座",
        "back_body": "民间异常现象记录员、野外调查研究者。战斗定位是稳定星反应辅助、后台副输出与轻重路线控场。",
        "tag": "基础信息",
    ...
    },
    {
        ...
        "subtitle": "-2 · -1 · 0 · +1 · +2",
        "back_title": "从归衡开始",
        "back_body": "战技启动时H为0。玩家选择轻重，两种星反应都积累所选方向；校读与爆发归衡，本轮成长保留。",
        "tag": "机制总览",
    ...
    },
    {
        ...
        "subtitle": "浮动、牵引、多目标。",
        "back_title": "普莎响应",
        "back_body": "选择轻端后，两种星反应都使衡标向轻端移动。普莎缓缓离地，雪粒反常地向上飘动，为战场带来牵引与浮动。",
        "tag": "轻端响应",
    ...
    },
    {
        ...
        "kicker": "重端",
        "title": "向重端",
        "subtitle": "高削韧、较高伤害、首领战。",
        "back_title": "伊嘉响应",
        "back_body": "选择重端后，两种星反应都使衡标向重端移动。伊嘉落地造成低沉冰裂；巡衡期间，范围内敌人持续受到冰雷减抗。",
        "tag": "重端响应",
    ...
    },
    {
        ...
        "back_title": "稳定的基础协同",
        "back_body": "巡衡提供后台冰、团队星反应增益与路线减抗。原生反应与辉映照常结算，H积累所选路线，归衡仅提升上限。",
        "tag": "战技",
    ...
    },
    {
        ...
        "back_title": "把失衡带回来",
        "back_body": "两种星反应都积累所选方向；本轮成长在归衡后保留，完整归衡再提供短暂额外窗口。",
        "tag": "天赋",
        "image": "nadia_h_zero_v1_ingame.png",
        "mode": "right_contain",
    },
